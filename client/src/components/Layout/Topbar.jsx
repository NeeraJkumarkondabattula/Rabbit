...
const Topbar = () => {
  const items = [
    {
      text: "We ship world wide - fast and reliable.",
      link: "/shipping",
    },
    {
      text: "Get your loved products with good offers!",
      link: "/offers",
    },
    {
      text: "Summer sale is ending soon.",
      link: "/summer-sale",
    },
  ];
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setDirection("out");
    }, 3500); // Start fade-out before full 4 seconds
